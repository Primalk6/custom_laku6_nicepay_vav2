          ...
          <tr>
            <td class="box" style="background-color:#fbfbfb;border:1px solid #d6d4d4!important;padding:10px!important">
              ...
              <span style="color:#777">
                Kami menunggu pembayaran anda melalui Keb Hana Virtual Account sebelum <strong><?php echo $_POST["expDate"]; ?></strong> agar kami bisa memproses order anda segera
              </span>
            </td>
          </tr>
